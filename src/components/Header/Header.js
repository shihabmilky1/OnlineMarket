        ...
        <div className="container">
          ...
          <div className="collapse navbar-collapse" id="navbarNavAltMarkup">
            <ul className="navbar-nav ms-auto hypertext d-lg-flex align-items-lg-center">
              ...
              <li className="nav-item">
                {!logInUser.email &&
                  <Link className="nav-link text-center mb-3 mb-lg-0" style={{ background: '#1765CC', padding: "7px 25px" }} to="/login"><b>Login</b></Link>}
              </li>
              {logInUser.email && <li className="nav-item dropdown">
                ...
                <ul className="dropdown-menu shadow text-center mb-3 mb-lg-0" id="responsiveDropdown" aria-labelledby="navbarDropdown">
                  <li><Link className="dropdown-item" to="/">{logInUser.name}</Link></li>
                  <li>   <button onClick={handleLogOut} className="nav-link m-auto mt-3" style={{ background: '#1765CC', padding: "7px 25px", color: '#fff', border: 'none' }} ><b>Logout</b></button></li>
                </ul>
              </li>}
              <li>
                <Link className="ms-lg-3" style={{ fontSize: '18px' }} to=""><FontAwesomeIcon icon={faCartPlus} /></Link>
              </li>
            </ul>
          </div>
        </div>
